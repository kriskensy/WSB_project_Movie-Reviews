...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 28, 2025 at 12:13 PM
...
(2, 'The Dark Knight', 1, 1, '2008-07-18', 'In Gotham City, chaos reigns as the Joker, a criminal mastermind with no clear motive beyond destruction, wreaks havoc. Batman, along with Commissioner Gordon and District Attorney Harvey Dent, tries to bring order to the city. The Joker\'s antics test Batman\'s resolve, forcing him to confront his own moral boundaries. Meanwhile, Dent\'s transformation into Two-Face adds layers of tragedy to the story. With intense action, psychological depth, and moral dilemmas, The Dark Knight redefines superhero storytelling.', NULL),
...
(1, 1, 1, 0, 'An absolute masterpiece with stunning visuals and a complex story.', '2023-01-15'),
(2, 1, 2, 0, 'A brilliant portrayal of Gotham with incredible performances.', '2023-01-16'),
(3, 1, 4, 0, 'Tarantino at his finest, a must-watch classic.', '2023-01-17'),
(4, 2, 3, 0, 'A visually stunning film with a strong emotional core.', '2023-01-18'),
(5, 2, 9, 0, 'A gripping tale of survival and science, truly inspiring.', '2023-01-20'),
(6, 2, 8, 0, 'A breathtaking epic with incredible performances and storytelling.', '2023-01-23'),
(7, 2, 10, 0, 'A thought-provoking sci-fi classic that stands the test of time.', '2023-01-24'),
(8, 3, 6, 0, 'Incredible visuals and a touching story about belonging.', '2023-01-25'),
(9, 3, 7, 0, 'A wild ride through greed, excess, and chaos.', '2023-01-26'),
(10, 4, 5, 0, 'A suspenseful, terrifying masterpiece of sci-fi horror.', '2023-01-27'),
(11, 1, 11, 0, 'A groundbreaking sci-fi film that redefined the genre.', '2023-01-28'),
(12, 2, 12, 0, 'An epic tale of revenge and redemption, beautifully executed.', '2023-01-29'),
(13, 3, 13, 0, 'One of the most powerful and moving films ever made.', '2023-01-30'),
(14, 4, 14, 0, 'A gritty and unflinching look at the world of organized crime.', '2023-01-31'),
(15, 5, 15, 0, 'A timeless love story with incredible visuals and music.', '2023-02-01'),
(16, 1, 16, 0, 'A fun and adventurous journey through Middle-earth.', '2023-02-02'),
(17, 2, 17, 0, 'Tarantino delivers another thrilling and thought-provoking masterpiece.', '2023-02-03'),
(18, 3, 18, 0, 'A heartwarming and emotional story about friendship and love.', '2023-02-04'),
(19, 4, 19, 0, 'A haunting and suspenseful film with brilliant performances.', '2023-02-05'),
(20, 5, 20, 0, 'An epic crime saga with stellar acting and direction.', '2023-02-06'),
(21, 1, 11, 0, 'A visually stunning and intellectually engaging sci-fi classic.', '2023-02-07'),
(22, 2, 12, 0, 'Russell Crowe shines in this incredible historical epic.', '2023-02-08'),
(23, 3, 13, 0, 'Steven Spielberg at his very best. A must-watch.', '2023-02-09'),
(24, 4, 14, 0, 'A gripping and intense mob drama that keeps you hooked.', '2023-02-10'),
(25, 5, 15, 0, 'Heartbreaking and beautiful. A true masterpiece.', '2023-02-11'),
(26, 1, 16, 0, 'An entertaining fantasy film with a great cast and stunning visuals.', '2023-02-12'),
(27, 2, 17, 0, 'A powerful story with unforgettable characters and moments.', '2023-02-13'),
(28, 3, 18, 0, 'A touching and magical experience that stays with you.', '2023-02-14'),
(29, 4, 19, 0, 'Jack Nicholson delivers an unforgettable performance.', '2023-02-15'),
(30, 5, 20, 0, 'A compelling and introspective look at life in the mob.', '2023-02-16'),
(31, 2, 11, 0, 'The Matrix is a cinematic masterpiece that combines action and philosophy.', '2023-02-17'),
(32, 3, 12, 0, 'Gladiator is a powerful and emotional journey.', '2023-02-18'),
(33, 4, 13, 0, 'Schindler’s List is an unforgettable film that everyone should see.', '2023-02-19'),
(34, 5, 14, 0, 'Goodfellas is an incredible film with great storytelling.', '2023-02-20'),
(35, 1, 15, 0, 'Titanic is a visually stunning and emotional masterpiece.', '2023-02-21');
...
--
ALTER TABLE `reviews`
  MODIFY `IdReview` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
